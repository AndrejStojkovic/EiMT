...
const DeleteAccommodationModal = ({
  open,
  accommodationName,
  deleting,
  errorMessage,
    ...
    <Dialog open={open} onClose={deleting ? undefined : onClose} fullWidth maxWidth='xs'>
      <DialogTitle sx={{ pb: 1 }}>
        <Stack direction='row' spacing={1} sx={{ alignItems: 'center' }}>
          ...
          <Typography variant='h6'>Delete accommodation</Typography>
        </Stack>
      </DialogTitle>
      <DialogContent>
        <Stack spacing={1.5}>
          ...
          <Typography variant='body1'>
            Are you sure you want to permanently remove <strong>{accommodationName}</strong>?
          </Typography>
